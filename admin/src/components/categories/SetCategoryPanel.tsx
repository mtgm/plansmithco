...
interface SetCategoryPanelProps {
...
export const SetCategoryPanel: React.FC<SetCategoryPanelProps> = ({
    companyId,
    companyName,
    canChangeCompany,
}) => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [editingCategory, setEditingCategory] = useState<SetCategory | null>(null);
    ...
    const openEditModal = (record: SetCategory) => {
    ...
    const handleSubmit = async () => {
        console.log('Submitting form for company:', companyName);
        try {
            setUploading(true);
    ...
    const handleDelete = async (record: SetCategory) => {
        ...
        >
            ...
            <div style={{ flex: 1, overflow: 'hidden' }}>
                <Table
                    ...
                    scroll={{ y: PANEL_HEIGHT - 130 }} // Adjusted scroll height
                >
                    <Table.Column
                    ...
                    <Table.Column
                        dataIndex="name"
                        title="Kategori Adı"
                        render={(value, record: SetCategory) => (
            ...
            {/* Create/Edit Modal */}
            <Modal
                title={editingCategory ? 'Kategori Düzenle' : 'Yeni Set Kategorisi'}
                open={isModalOpen}
            ...
            >
                <Form form={form} layout="vertical">
                    ...
                    >
                        <Input placeholder="Örn: Mobilya Setleri" />
                    </Form.Item>
